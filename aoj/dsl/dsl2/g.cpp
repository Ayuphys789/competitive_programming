/**
 * Author: Ayuphys
 * Problem Number: dsl-2-g
 * Title: RSQ and RAQ
 * Link to the Problem: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_G
 * Link to the Submission: https://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=10308216#2
 * Difficulty:
 */
...
void Ayuphys_solve(void)
{
    int N, Q;
    cin >> N >> Q;
    vector<node_sum_add> A(N, {0LL, 1LL});
