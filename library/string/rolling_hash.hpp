...
// verified with: "/atcoder/typical90/047.cpp"

#include "/home/ayuphys789/competitive_programming/template/template.hpp"
#include "/home/ayuphys789/competitive_programming/library/math/combinatorics/modint_2_61m1.hpp"
...
private:
    ...
    static mint61 generate_base()
    {
        mt19937_64 mt(chrono::steady_clock::now().time_since_epoch().count());
        uniform_int_distribution<uint64_t> rand(1, mint61::mod() - 1);
        return mint61(rand(mt));
    }

    static mint61 base, base_inv;
    static vector<mint61> bases, base_invs;

    vector<T> pre, suf;
    vector<mint61> PRE{mint61(0)}, SUF{mint61(0)};
...
public:
    ...
    void push_front(T c)
    {
        ...
        PRE.push_back(PRE.back() + base_invs[pre.size() + 1] * mint61(c));
        pre.push_back(c);
    }
    ...
    void push_back(T c)
    {
        ...
        SUF.push_back(SUF.back() + bases[suf.size()] * mint61(c));
        suf.push_back(c);
    }
    ...
    static mint61 combine(mint61 h1, int h1_len, mint61 h2)
    {
        expand_bases(h1_len);
